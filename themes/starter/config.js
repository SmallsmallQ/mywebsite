...
const CONFIG = {
  ...
  STARTER_LOGO: '/images/starter/logo/mypicture.jpg', // 普通logo图片 示例：/images/starter/logo/logo.svg
  ...
  STARTER_HERO_TITLE_1: '我是小Q，来自西安交通大学！', // 英雄区文字
  STARTER_HERO_TITLE_2: 'intj，一个吃货', // 英雄区文字
  // 英雄区两个按钮，如果TEXT留空则隐藏按钮
  STARTER_HERO_BUTTON_1_TEXT: '关于我', // 英雄区按钮
  ...
  // 英雄区配图，如需隐藏，改为空值即可 ''
  STARTER_HERO_PREVIEW_IMAGE: 'images/starter/hero/viewmywebsite.png', // 产品预览图 ，默认读取public目录下图片
